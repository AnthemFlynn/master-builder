...
import redstone_lamp_on from '../../static/textures/block/redstone_lamp_on.png'
...
const glowstoneMaterial = loader.load(glowstone)
const redstoneLampMaterial = loader.load(redstone_lamp_on)
...
glowstoneMaterial.magFilter = THREE.NearestFilter
redstoneLampMaterial.magFilter = THREE.NearestFilter
